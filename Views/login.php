...
<body>
  <!-- component -->
  <div class="bg-gray-00 dark:bg-gray-700">
            ...
            <div class="flex items-center w-full max-w-md px-6 mx-auto lg:w-2/6">
                <div class="flex-1">
                    <div class="text-center">
                        <h2 class="text-4xl font-bold text-center text-gray-700 dark:text-white">E-KELONTONG</h2>
                        
                        <p class="mt-3 text-gray-500 dark:text-gray-300">Silahkan login</p>
                    </div>
                    ...
                    <div class="mt-8">
                        ...
                        <p class="mt-6 text-sm text-center text-gray-400">Don&#x27;t have an account yet? <a href="register.php" class="text-blue-500 focus:outline-none focus:underline hover:underline">Sign up</a>.</p>
                    </div>
                </div>
            </div>
        </div>
